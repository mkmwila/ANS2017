...
if("TRUE" STREQUAL "TRUE")
  set(image_publisher_SOURCE_PREFIX /home/terence/dev/ANS2017/22. ROS/catkin_ws/src/image_publisher)
  set(image_publisher_DEVEL_PREFIX /home/terence/dev/ANS2017/22. ROS/catkin_ws/devel)
  ...
  set(image_publisher_INSTALL_PREFIX /home/terence/dev/ANS2017/22. ROS/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'terence <terence@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/terence/dev/ANS2017/22. ROS/catkin_ws/src/image_publisher/${idir}'.  Ask the maintainer 'terence <terence@todo.todo>' to fix it.")
    endif()
